...
const classesData: ClassData[] = [
  ...
  },
  {
    ...
    custodialPower: 'The Curator Arcanum',
    description: 'Those who rewrite the laws of reality through applied understanding. Weavers are the only class capable of casting Legendary tier spells. Fragile but devastating, they trade durability for the ability to reshape existence itself.',
    keyAbilities: [
      { name: 'Spell Supremacy', desc: 'Can cast Legendary tier spells' },
    ...
    progression: [
      ...
      { level: 9, prof: 5, hd: '15d6', milestone: 'Legendary Casting', way: '—' },
